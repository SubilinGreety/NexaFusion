  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="section-container relative z-10">
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-3xl p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
          {/* Grid pattern background inside inner box */}
          <div className="absolute inset-0 bg-grid-pattern bg-[size:3rem_3rem] opacity-10 pointer-events-none" />
          
          {/* Glow orbs inside inner box */}
          <div className="absolute top-[-100px] left-[-50px] w-[500px] h-[400px] rounded-full bg-white/10 blur-3xl pointer-events-none" />
          <div className="absolute bottom-[-80px] right-[-50px] w-[400px] h-[300px] rounded-full bg-white/10 blur-3xl pointer-events-none" />
          ...
          <span className="inline-block text-blue-200 font-semibold uppercase tracking-[0.15em] text-xs px-3 py-1 bg-white/10 border border-white/20 rounded-full mb-4 relative z-10">
            Ready to Start?
          </span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white leading-[1.15] tracking-tight mt-3 mb-5 max-w-3xl mx-auto relative z-10">
            Let&apos;s Build Something{" "}
            <span className="text-sky-300">Extraordinary Together</span>
          </h2>
          <p className="text-blue-100 max-w-xl mx-auto mb-10 leading-relaxed relative z-10">
